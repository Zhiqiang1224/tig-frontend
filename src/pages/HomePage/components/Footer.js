		...
		return (
			<div className={style.foot}>
				<Row>
					...
					<Col span={5}>
						<img src={logo_tiggidoo_blanc} alt={this.state.language.Text_62} width="230px" style={{ marginTop: "200px" }} />
						<div style={{ color: "#ffffff", fontSize: "15px", marginTop: "20px" }}>{this.state.language.Text_30}</div>
					</Col>
					<Col span={6} offset={4}>
						<div style={{ color: "#ffffff", fontSize: "25px", marginTop: "180px", marginLeft: "18px",  fontWeight: 600 }}>{this.state.language.Text_29}</div>
